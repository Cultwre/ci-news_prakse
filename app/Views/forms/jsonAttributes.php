<?php
  echo "<script>let attributesData = '$attributesData';</script>";
  echo "<script>let metaValue = '$metaValue';</script>";
?>

<div class="container">
<button class="btn btn-primary" id="addbutton" title="Add"><span class="fa fa-plus-square"></span></button>
  
  <table cellpadding="0" cellspacing="" border="0" class="dataTable table table-striped" id="attributes-table">
